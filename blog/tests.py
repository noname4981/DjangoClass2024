...
class TestView(TestCase):
    def setUp(self):
        ...
        self.category_programming = Category.objects.create(name='progmraming',slug='programing')
    ...
    def test_post_list(self):
        ...
        self.assertIn(self.post_002.title, post_003_card.text)
    ...
    def test_post_detail(self):
        ...
        self.navbar_test(soup)
        #2.3. 첫 번째 포스트의 제목이 웹 브라우저 타이틀에 들어 있다.
